...
@Component({
  selector: 'app-indemnite-content',
  templateUrl: './indemnite-content.component.html',
  styleUrls: ['./indemnite-content.component.scss']
})
export class IndemniteContentComponent  implements OnInit {
  @Input('indemnite') indemnite!: IndemniteModel;
  @Input('currentUser') currentUser!: PersonnelModel;

  formContentGroup: FormGroup | any;
