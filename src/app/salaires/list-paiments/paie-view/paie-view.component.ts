  ...
  constructor(
          ...
          this.reglageService.preference(this.currentUser.code_entreprise).subscribe(res => {
            ...
            this.salaireService.getAnciennete(this.currentUser.code_entreprise, this.personne.id, date_contrat, datePaie).subscribe(
              date_debut_contrat => {
                ...
                console.log('date_debut_contrats', date_debut_contrats);
    ...
    onSubmit() {
      try {
        ...
        var date = new Date(this.date_paie);
        ...
        totalJrsPreste = this.nbreJrsPreste + nbre_jrs_ferie - 1;  // Les jours prestés ne doit pas compter le jour de paie alors il faut mettre -1
