  ...
  constructor(
    ...
    delete(id: number): void {
      if (confirm('Êtes-vous sûr de vouloir supprimer cet enregistrement ?')) { 
        var date = new Date(this.salaire.personnel.date_paie);
        var date_precedante = new Date(date);
        date_precedante.setDate(date.getDate()-30);
        var personnel = {
          date_paie: date_precedante,
