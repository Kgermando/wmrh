...
export class PresenceMonthComponent implements OnInit{
  ...
  getPiePresence() {
    ...
    getCourbepresence() {
        this.presenceDashService.getCourbePresenceMonth(this.currentUser.code_entreprise).subscribe(
            res => {
                ...
                this.chartOptionCourbePresence = {
                    ...
                    xaxis: {
                        ...
                        categories: this.courbePresenceList.map((item: any) => item.day),
                        labels: {
                            style: {
                                colors: "#a9a9c8",
                                fontSize: "14px"
