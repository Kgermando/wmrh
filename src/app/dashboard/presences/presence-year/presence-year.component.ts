...
@Component({
  selector: 'app-presence-year',
  templateUrl: './presence-year.component.html',
  styleUrls: ['./presence-year.component.scss']
})
export class PresenceYearComponent implements OnInit{
  ...
  getPiePresence() {
    ...
    getCourbepresence() {
        this.presenceDashService.getCourbePresenceYear(this.currentUser.code_entreprise).subscribe(
            res => {
                ...
                this.chartOptionCourbePresence = {
                    ...
                    xaxis: {
                        ...
                        categories: this.courbePresenceList.map((item: any) => {
                            if (item.month == 1) {
                                return "Jan";
