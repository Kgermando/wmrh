...
@Component({
  ...
  templateUrl: './finance-month.component.html',
  styleUrls: ['./finance-month.component.scss']
})
export class FinanceMonthComponent implements OnInit{
    ...
    this.authService.user().subscribe({
      next: (user) => {
        ...
        this.reglageService.preference(this.currentUser.code_entreprise).subscribe(res => {
            this.preference = res; 
            this.financeService.totalRBIMonth(this.currentUser.code_entreprise).subscribe(
                res =>  {
  ...
  getAllocations() {
   ...
   getNetAPayerCCNSSQPO() {
    this.financeService.depensePayEMonth(this.currentUser.code_entreprise).subscribe(
        res => {
