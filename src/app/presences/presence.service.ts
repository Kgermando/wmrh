...
export class PresenceService extends ApiService {
  ...
  getRegisterMonth(code_entreprise: string, site_location: string, date_presence: string): Observable<any> {
    return this.http.get(`${this.endpoint}/get-registre-month/${code_entreprise}/${site_location}/${date_presence}`);
  } 
  ...
  getAllItem(code_entreprise: string, matricule: string): Observable<any> {
    return this.http.get(`${this.endpoint}/get-all-item/${code_entreprise}/${matricule}`);
  }
