...
import { OffreViewComponent } from './recrutements/offres/offre-view/offre-view.component';
import { OffreViewCandidatureComponent } from './recrutements/offres/offre-view-candidature/offre-view-candidature.component';
...
const routes: Routes = [
  ...
  { path: 'layouts', component: LayoutsComponent, children: [
    ...
    { path: 'presences/horaires', component: HorairesComponent, children: [
      { path: ':id/calendar', component: HoraireComponent},
      { path: ':id/horaire-edit', component: HoraireEditComponent},
  ...
  { path: 'recrutements/offres/:id', component: OffreViewComponent },
  { path: 'recrutements/offres/:id/candidature-add', component: OffreViewCandidatureComponent },
