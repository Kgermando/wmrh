...
@Component({
  selector: 'app-horaire-shift-two',
  templateUrl: './horaire-shift-two.component.html',
  styleUrls: ['./horaire-shift-two.component.scss']
})
export class HoraireShiftTwoComponent {
