...
@Component({
  selector: 'app-horaire-shift-tree',
  templateUrl: './horaire-shift-tree.component.html',
  styleUrls: ['./horaire-shift-tree.component.scss']
})
export class HoraireShiftTreeComponent {
